# lotto
 ...
 ## Тестовое задание:
 Разработать небольшую лотерею, где игрок должен выбрать на первом поле 8 из 19 чисел, на втором 1 из 2 чисел. После отправки результата происходит сравнение выбранных чисел со случайно сгенерированным полем. При условии, что сумарно отгадано 4 и более чисел, игрок побеждает.
...
Реализована возможность генерации случайного выбора чисел, при нажатии на кнопку в верхнем правом углу.

Адаптивная Modile-first верстка (стили разработаны с использованием display flex 
